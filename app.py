...
from resourses.item import blp as ItemBlueprint
...
def create_app(db_url=None):
   ...
   api=Api(app)
   app.config["JWT_SECRET_KEY"]=os.getenv("JWT_SECRET_KEY", "sakshi")
   jwt=JWTManager(app)
   ...
   # Looks in database whether the user is an admin or not
